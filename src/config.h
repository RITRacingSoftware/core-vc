...
/** POWER LIMIT **/
#define PL_THRESHOLD 0.1f
#define PL_MAX_POWER_W 70000

/** CAN **/
#define CAN_SENSE FDCAN1
#define CAN_MAIN FDCAN2
#define CAN_INV FDCAN3
#define NUM_IDS_MAIN 6
...
#define BPS_SOFT_PRESSED_PCT 0.1
#define BPS_HARD_PRESSED_PCT 0.2
...
#define DI_ACCEL_SOFT_DP_THRESHOLD 15
#define DI_ACCEL_HARD_DP_THRESHOLD 25
