/*
 * F34_Torque_Vectoring_Simulink_v1_5.c
 *
...
/* Model step function */
void F34_Torque_Vectoring_Simulink_v1_5_step(void)
{
   ...
   */
  rtb_Max = sinf(0.270833343F * rtb_FrontTCLong * 0.0174532924F * 0.5F) * 2.0F *
    rtb_BodyVelocityms / (rtb_BodyVelocityms * rtb_BodyVelocityms * (100000.0F *
    F34_Torque_Vectoring_Simulink_U.YawParams_d.Understeer_Gradient) + 1.5748F);

  /* RateLimiter: '<S2>/Desired Yaw Rate Limiter' */
  rtb_e_yaw_ratekI = rtb_Max - F34_Torque_Vectoring_Simulin_DW.PrevY;
  if (rtb_e_yaw_ratekI > 1.0F) {
    rtb_DesiredYawRateLimiter = F34_Torque_Vectoring_Simulin_DW.PrevY + 1.0F;
  } else if (rtb_e_yaw_ratekI < -1.0F) {
    rtb_DesiredYawRateLimiter = F34_Torque_Vectoring_Simulin_DW.PrevY - 1.0F;
  } else {
   ...
   *  Sum: '<S4>/Subtract'
   */
  rtb_Divide[0] = (0.0017426972F *
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Feedback_Speeds
                   [0] -
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.X_velocity) /
    rtb_Max;
  rtb_Divide[1] = (0.0017426972F *
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Feedback_Speeds
                   [1] -
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.X_velocity) /
    rtb_Max;
  rtb_Divide[2] = (0.0017426972F *
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Feedback_Speeds
                   [2] -
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.X_velocity) /
    rtb_Max;
  rtb_Divide[3] = (0.0017426972F *
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Feedback_Speeds
                   [3] -
                   F34_Torque_Vectoring_Simulink_U.VariableInBus_g.X_velocity) /
    rtb_Max;
  ...
  if ((F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Power_Limit_Flag == 1.0F)
     ...
     */
    F34_Torque_Vectoring_Simulink_Y.WheelTorqueRequestsNm[0] = rtb_Max;

    /* SignalConversion generated from: '<S3>/Vector Concatenate' incorporates:
     *  Outport: '<Root>/Wheel Torque Requests [Nm]'
     */
    F34_Torque_Vectoring_Simulink_Y.WheelTorqueRequestsNm[1] = rtb_Max;

    /* SignalConversion generated from: '<S3>/Vector Concatenate' incorporates:
     *  Outport: '<Root>/Wheel Torque Requests [Nm]'
     */
    F34_Torque_Vectoring_Simulink_Y.WheelTorqueRequestsNm[2] = rtb_Max;

    /* SignalConversion generated from: '<S3>/Vector Concatenate' incorporates:
     *  Outport: '<Root>/Wheel Torque Requests [Nm]'
     */
    F34_Torque_Vectoring_Simulink_Y.WheelTorqueRequestsNm[3] = rtb_Max;
    ...
    if (F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Total_Torque_Request >=
       ...
       */
      rtb_Max = F34_Torque_Vectoring_Simulink_U.LongParams_g.Throttle_Long_Split;
    } else {
      /* Switch: '<S7>/Long Split (Static)' incorporates:
       *  Inport: '<Root>/LongParams'
       */
      rtb_Max = F34_Torque_Vectoring_Simulink_U.LongParams_g.Regen_Long_Split;
    }

    /* Gain: '<S9>/Half Total Torque [Nm]' */
    rtb_RightSideTorqueNm = 0.5F *
      F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Total_Torque_Request;
    ...
    if (rtb_BodyVelocityms < 0.3F) {
       ...
       */
      rtb_e_yaw_ratekI = F34_Torque_Vectoring_Simulink_U.YawParams_d.kI_Yaw_Rate
       ...
       */
      if (rtIsNaNF(rtb_BodyVelocityms) || rtIsInfF(rtb_BodyVelocityms)) {
        rtb_BodyVelocityms = 0.0F;
      }
      ...
      F34_Torque_Vectoring_Simulin_DW.YawRateIntegrator_DSTATE = 0.005F *
        rtb_e_yaw_ratekI + F34_Torque_Vectoring_Simulink_Y.Yaw_Rate_Integral_nm;
      if (F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Yaw_Rate > 0.0F) {
     ...
     */
    rtb_e_yaw_ratekI = rtb_BodyVelocityms -
    ...
    if (rtb_e_yaw_ratekI > 1.0F) {
      ...
      F34_Torque_Vectoring_Simulink_Y.LateralTorqueBiasNm = rtb_BodyVelocityms;
    }
    ...
    /* Gain: '<S9>/Half Lateral Torque Bias [Nm]' incorporates:
     *  Outport: '<Root>/Lateral Torque Bias [Nm]'
     */
    rtb_BodyVelocityms = 0.5F *
      F34_Torque_Vectoring_Simulink_Y.LateralTorqueBiasNm;

    /* Sum: '<S9>/Left Side Torque [Nm]' */
    rtb_e_yaw_ratekI = rtb_RightSideTorqueNm - rtb_BodyVelocityms;
    ...
    /* Switch: '<S7>/Long Factor (Dynamic)' incorporates:
     *  Inport: '<Root>/LongParams'
     */
    if (F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Total_Torque_Request >=
        0.0F) {
      rtb_FrontTCLong =
        F34_Torque_Vectoring_Simulink_U.LongParams_g.Throttle_Long_Factor;
    } else {
      rtb_FrontTCLong =
        F34_Torque_Vectoring_Simulink_U.LongParams_g.Regen_Long_Factor;
    }

    /* Sum: '<S9>/Pct. Front [0-1]' incorporates:
     *  Product: '<S9>/Dynamic Long. Split'
     *  Switch: '<S7>/Long Factor (Dynamic)'
     */
    rtb_FrontTCLong = rtb_Max -
      F34_Torque_Vectoring_Simulink_B.MovingAverage.MovingAverage *
      rtb_FrontTCLong;

    /* Saturate: '<S9>/Long. Split Saturation' */
    if (rtb_FrontTCLong > 1.0F) {
      rtb_FrontTCLong = 1.0F;
    } else if (rtb_FrontTCLong < 0.0F) {
      rtb_FrontTCLong = 0.0F;
    }

    /* End of Saturate: '<S9>/Long. Split Saturation' */

    /* Product: '<S9>/LF' */
    rtb_VectorConcatenate[0] = rtb_e_yaw_ratekI * rtb_FrontTCLong;

    /* Product: '<S9>/LR' incorporates:
     *  Constant: '<S9>/Const.'
     *  Sum: '<S9>/Pct. Rear [0-1]'
     */
    rtb_VectorConcatenate[1] = (1.0F - rtb_FrontTCLong) * rtb_e_yaw_ratekI;

    /* Sum: '<S9>/Right Side Torque [Nm]' */
    rtb_RightSideTorqueNm += rtb_BodyVelocityms;

    /* Product: '<S9>/RF' */
    rtb_VectorConcatenate[2] = rtb_RightSideTorqueNm * rtb_FrontTCLong;

    /* Product: '<S9>/RR' incorporates:
     *  Constant: '<S9>/Const.'
     *  Sum: '<S9>/Pct. Rear [0-1]'
     */
     ...
     *  Gain: '<Root>/Y Accel [G]'
     */
    rtb_RightSideTorqueNm = fabsf(0.101971619F *
     ...
     *  Switch: '<S13>/Switch'
     */
    if (rtb_RightSideTorqueNm > 10.0F) {
      rtb_RightSideTorqueNm = 10.0F;
     ...
     *  Switch: '<S13>/Switch2'
     */
    rtb_RightSideTorqueNm = (rtb_RightSideTorqueNm -
      F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_Ay_min) *
     ...
     *  Switch: '<S14>/Switch'
     */
    if (rtb_RightSideTorqueNm > 1.0F) {
      rtb_e_yaw_ratekI = 1.0F;
    } else if (rtb_RightSideTorqueNm <
               F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_Lat_min) {
      /* Switch: '<S14>/Switch' incorporates:
       *  Inport: '<Root>/TCParams'
       */
      rtb_e_yaw_ratekI = F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_Lat_min;
    } else {
      rtb_e_yaw_ratekI = rtb_RightSideTorqueNm;
    }
     ...
     */
    rtb_RightSideTorqueNm = rtb_FrontTCLong + rtb_e_yaw_ratekI;
    rtb_FrontTCLong = rtb_RightSideTorqueNm;
    ...
    if (rtb_RightSideTorqueNm >
      ...
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_max;
    } else if (rtb_RightSideTorqueNm <
               F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_min) {
      /* Switch: '<S15>/Switch' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_min;
    }

    /* RateLimiter: '<S8>/Target S.R. Rate Limiter' */
    rateLimiterRate = rtb_FrontTCLong - F34_Torque_Vectoring_Simulin_DW.PrevY_g
      [0];
    if (rateLimiterRate > 0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[0] + 0.0008F;
    } else if (rateLimiterRate < -0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[0] - 0.0008F;
    }
    ...
    /* Outport: '<Root>/Target_Slip_Ratios_' */
    F34_Torque_Vectoring_Simulink_Y.Target_Slip_Ratios_[0] = rtb_FrontTCLong;
     ...
     *  Outport: '<Root>/Target_Slip_Ratios_'
     */
    F34_Torque_Vectoring_Simulin_DW.PrevY_g[0] = rtb_FrontTCLong;

    /* Sum: '<S8>/Add1' incorporates:
     *  SignalConversion generated from: '<S8>/Vector Concatenate1'
     */
    rtb_e_yaw_ratekI += rtb_BodyVelocityms;
    rtb_FrontTCLong = rtb_e_yaw_ratekI;
     ...
     *  Switch: '<S15>/Switch'
     */
    if (rtb_e_yaw_ratekI > F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_max)
    {
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_max;
    } else if (rtb_e_yaw_ratekI <
               F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_min) {
      /* Switch: '<S15>/Switch' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_SR_min;
    }
    ...
    if (rateLimiterRate > 0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[1] + 0.0008F;
    } else if (rateLimiterRate < -0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[1] - 0.0008F;
    }
    ...
    /* Outport: '<Root>/Target_Slip_Ratios_' */
    F34_Torque_Vectoring_Simulink_Y.Target_Slip_Ratios_[1] = rtb_FrontTCLong;
     ...
     *  Outport: '<Root>/Target_Slip_Ratios_'
     */
    F34_Torque_Vectoring_Simulin_DW.PrevY_g[1] = rtb_FrontTCLong;
    ...
    if (rateLimiterRate > 0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[2] + 0.0008F;
    } else if (rateLimiterRate < -0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[2] - 0.0008F;
    }
    ...
    /* Outport: '<Root>/Target_Slip_Ratios_' */
    F34_Torque_Vectoring_Simulink_Y.Target_Slip_Ratios_[2] = rtb_FrontTCLong;
     ...
     *  Outport: '<Root>/Target_Slip_Ratios_'
     */
    F34_Torque_Vectoring_Simulin_DW.PrevY_g[2] = rtb_FrontTCLong;
    ...
    if (rateLimiterRate > 0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[3] + 0.0008F;
    } else if (rateLimiterRate < -0.0008F) {
      /* Outport: '<Root>/Target_Slip_Ratios_' */
      rtb_FrontTCLong = F34_Torque_Vectoring_Simulin_DW.PrevY_g[3] - 0.0008F;
    }
    ...
    /* Outport: '<Root>/Target_Slip_Ratios_' */
    F34_Torque_Vectoring_Simulink_Y.Target_Slip_Ratios_[3] = rtb_FrontTCLong;
    ...
    for (ForEach_itr = 0; ForEach_itr < 4; ForEach_itr++) {
      ...
      if (F34_Torque_Vectoring_Simulink_U.TCParams_i.TC_Activation_Threshold *
         ...
         */
        rtb_RightSideTorqueNm =
          F34_Torque_Vectoring_Simulink_B.CoreSubsys[ForEach_itr].
         ...
         *  UnitDelay: '<S18>/UD'
         */
        rtb_e_yaw_ratekI = ((rtb_e_slip_ratio *
      ...
      if (rtb_e_yaw_ratekI > 21.0F) {
        rtb_e_yaw_ratekI = 21.0F;
      } else if (rtb_e_yaw_ratekI < 0.0F) {
        rtb_e_yaw_ratekI = 0.0F;
      }
    ...
    if (!(F34_Torque_Vectoring_Simulink_U.VariableInBus_g.Total_Torque_Request >=
          0.0F)) {
      rtb_ImpAsg_InsertedFor_WheelTor[0] = rtb_VectorConcatenate[0];
      rtb_ImpAsg_InsertedFor_WheelTor[1] = rtb_VectorConcatenate[1];
      rtb_ImpAsg_InsertedFor_WheelTor[2] = rtb_VectorConcatenate[2];
      rtb_ImpAsg_InsertedFor_WheelTor[3] = rtb_VectorConcatenate[3];
    }
    ...
    if (!F34_Torque_Vectoring_Simulin_DW.s_not_empty) {
      ...
      rtb_RightSideTorqueNm = rtb_e_yaw_ratekI * rtb_Max;
      F34_Torque_Vectoring_Simulin_DW.preloadTorques[0] = rtb_RightSideTorqueNm;
      rtb_e_yaw_ratekI *= 1.0F - rtb_Max;
      F34_Torque_Vectoring_Simulin_DW.preloadTorques[1] = rtb_e_yaw_ratekI;
      F34_Torque_Vectoring_Simulin_DW.preloadTorques[2] = rtb_RightSideTorqueNm;
      F34_Torque_Vectoring_Simulin_DW.preloadTorques[3] = rtb_e_yaw_ratekI;
    }
    ...
    switch (F34_Torque_Vectoring_Simulin_DW.s) {
     ...
     case 4U:
      if (F34_Torque_Vectoring_Simulink_U.VariableInBus_g.X_velocity >
        ...
        rtb_RightSideTorqueNm = fminf(fmaxf((F34_Torque_Vectoring_Simulin_DW.t -
          F34_Torque_Vectoring_Simulin_DW.t0) /
          F34_Torque_Vectoring_Simulink_U.LCParams_e.LC_wblend1, 0.0F), 1.0F);
        rtb_e_yaw_ratekI = rtb_RightSideTorqueNm *
          F34_Torque_Vectoring_Simulink_U.LCParams_e.LC_Tmax;
        rtb_FrontTCLong = 0.5F * rtb_Max * rtb_e_yaw_ratekI;
        rtb_VectorConcatenate[0] = rtb_FrontTCLong +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[0];
        rtb_e_yaw_ratekI *= (1.0F - rtb_Max) * 0.5F;
        rtb_VectorConcatenate[1] = rtb_e_yaw_ratekI +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[1];
        rtb_VectorConcatenate[2] = rtb_FrontTCLong +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[2];
        rtb_VectorConcatenate[3] = rtb_e_yaw_ratekI +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[3];
      } else {
        rtb_BodyVelocityms = fmaxf(fminf(((F34_Torque_Vectoring_Simulin_DW.t -
          F34_Torque_Vectoring_Simulin_DW.t0) -
          F34_Torque_Vectoring_Simulink_U.LCParams_e.LC_wblend1) /
          (F34_Torque_Vectoring_Simulink_U.LCParams_e.LC_wblend2 -
           F34_Torque_Vectoring_Simulink_U.LCParams_e.LC_wblend1), 1.0F), 0.0F);
        rtb_FrontTCLong = F34_Torque_Vectoring_Simulink_U.LCParams_e.LC_Tmax *
          0.5F;
        rtb_e_yaw_ratekI = rtb_FrontTCLong * rtb_Max;
        rtb_VectorConcatenate[0] = (rtb_e_yaw_ratekI +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[0]) * (1.0F -
          rtb_BodyVelocityms) + rtb_BodyVelocityms *
          rtb_ImpAsg_InsertedFor_WheelTor[0];
        rtb_FrontTCLong *= 1.0F - rtb_Max;
        rtb_VectorConcatenate[1] = (rtb_FrontTCLong +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[1]) * (1.0F -
          rtb_BodyVelocityms) + rtb_BodyVelocityms *
          rtb_ImpAsg_InsertedFor_WheelTor[1];
        rtb_VectorConcatenate[2] = (rtb_e_yaw_ratekI +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[2]) * (1.0F -
          rtb_BodyVelocityms) + rtb_BodyVelocityms *
          rtb_ImpAsg_InsertedFor_WheelTor[2];
        rtb_VectorConcatenate[3] = (rtb_FrontTCLong +
          F34_Torque_Vectoring_Simulin_DW.preloadTorques[3]) * (1.0F -
          rtb_BodyVelocityms) + rtb_BodyVelocityms *
     ...
     *  MATLAB Function: '<S1>/LC_State_Machine'
     */
    F34_Torque_Vectoring_Simulink_Y.LC_ramp_pct = rtb_RightSideTorqueNm;

    /* Outport: '<Root>/LC_blend_pct' incorporates:
     *  MATLAB Function: '<S1>/LC_State_Machine'
     */
    F34_Torque_Vectoring_Simulink_Y.LC_blend_pct = rtb_BodyVelocityms;

    /* Switch: '<S1>/NaN Inf Rejection' incorporates:
     *  RelationalOperator: '<S1>/IsFinite'
     */
    if ((!rtIsNaNF(rtb_VectorConcatenate[0])) && (!rtIsInfF
         (rtb_VectorConcatenate[0]))) {
      /* Outport: '<Root>/Wheel Torque Requests [Nm]' */
    ...
    if ((!rtIsNaNF(rtb_VectorConcatenate[1])) && (!rtIsInfF
         (rtb_VectorConcatenate[1]))) {
      /* Outport: '<Root>/Wheel Torque Requests [Nm]' */
    ...
    if ((!rtIsNaNF(rtb_VectorConcatenate[2])) && (!rtIsInfF
         (rtb_VectorConcatenate[2]))) {
      /* Outport: '<Root>/Wheel Torque Requests [Nm]' */
    ...
    if ((!rtIsNaNF(rtb_VectorConcatenate[3])) && (!rtIsInfF
         (rtb_VectorConcatenate[3]))) {
      /* Outport: '<Root>/Wheel Torque Requests [Nm]' */
...
void F34_Torque_Vectoring_Simulink_v1_5_initialize(void)
{
  /* Registration code */
...
void F34_Torque_Vectoring_Simulink_v1_5_terminate(void)
{
  /* local scratch DWork variables */
  int32_T ForEach_itr;
