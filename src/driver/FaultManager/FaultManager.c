...
#define IGNORE_LIST (FAULT_RBPS_IRRA | FAULT_RSSDB_LOST | FAULT_DOUBLE_PEDAL | FAULT_SOFT_DOUBLE_PEDAL | FAULT_VN_IRR | FAULT_VN_NO_LOCK | FAULT_FBPS_IRRA | FAULT_VN_LOST | FAULT_CURRENT_IRR)
